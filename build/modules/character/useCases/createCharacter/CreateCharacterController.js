...
const CreateChatacterUseCase_1 = require("./CreateChatacterUseCase");
class CreateCharacterController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { nickname, realm, main_spec } = request.body;
            const { player_id } = request.headers;
            const createCharacterUseCase = tsyringe_1.container.resolve(CreateChatacterUseCase_1.CreateCharacterUseCase);
            try {
                const character = yield createCharacterUseCase.execute({
                    nickname,
                    realm,
                    main_spec,
                    player_id,
